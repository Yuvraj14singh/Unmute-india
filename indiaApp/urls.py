...
urlpatterns = [
 ...
 path('voices/', views.stories, name='voices'),
 path('voices/text/', views.story_format_page, {'story_format':'text'}, name='voices_text'),
 path('voices/voice/', views.story_format_page, {'story_format':'voice'}, name='voices_voice'),
 path('voices/video/', views.story_format_page, {'story_format':'video'}, name='voices_video'),
 ...
 path('stories/<int:pk>/comments/', views.story_comments, name='story_comments'),
